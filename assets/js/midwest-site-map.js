    ...
    var SITES = [
        {
            ...
            region: "Illinois",
            abbr: "IL",
            operator: "Multiple hyperscalers proposed — Grundy County",
            why: "A proposed hyperscale campus here would draw on the $1.5 billion Lake Michigan pipeline that Joliet and its neighbours built to replace a failing deep aquifer. Estimates put the site's demand at up to 30 percent of a pipeline sized for drinking water, which makes Minooka the most legally live data-center fight in Illinois — and one Chicagoans can drive to in an hour.",
            community: "Grundy County residents and the south-west Chicago suburbs, who financed the pipeline as a household water supply and are now being asked to share it with a compute campus.",
            sources: "Great Lakes Now (June 2025) · Alliance for the Great Lakes fact sheet · RE-AMP Network, Q1 2025 analysis",
            image: "assets/img/site-minooka.jpg",
            imageAlt: "Water main pipe laid across open ground",
            x: 528.1,
            y: 614.5
        },
        {
            ...
            abbr: "IL",
            operator: "Meta",
            why: "Meta's DeKalb campus is the largest data center in Illinois, roughly an hour west of DePaul. It sits on land that was row-crop farmland a decade ago, and its expansion phases keep converting more of it. A second Illinois pin grounds the map in the state's own landscape rather than making the story a Chicago story.",
            community: "DeKalb residents living with farmland conversion, groundwater draw, and a tax-abatement deal negotiated before anyone was tracking water.",
            sources: "Data Center Frontier · DeKalb Daily Chronicle · Meta sustainability reports",
            image: "assets/img/site-dekalb.jpg",
            imageAlt: "Aerial view of farmland at the edge of development",
            x: 497.3,
            y: 579.9
        },
        {
            ...
            abbr: "IA",
            operator: "Microsoft",
            why: "This is where GPT-4 was trained. Shaolei Ren's team at UC Riverside used this facility's own environmental disclosures to calculate the water footprint of that training run — roughly 700,000 litres of freshwater. It is the rare site where a specific model and a specific volume of water can be named in the same sentence.",
            community: "West Des Moines' aquifer and the Raccoon River watershed, already under nitrate pressure from agriculture before cooling demand was added.",
            sources: "Shaolei Ren et al., “Making AI Less Thirsty” (2023) · AP News · Bloomberg 2025 mapping project",
            image: "assets/img/site-westdesmoines.jpg",
            imageAlt: "Cooling towers standing behind a body of water",
            x: 215,
            y: 621.6
        },
        {
            ...
            abbr: "IA",
            operator: "Google",
            why: "Google's largest US campus, and — thanks to litigation in Oregon that forced per-site water disclosure — one of the most thoroughly documented water footprints of any hyperscale facility anywhere. Council Bluffs alone reports over one billion gallons of water use per year.",
            community: "Missouri River withdrawals and the competition between an industrial campus and the municipal supply that serves the city around it.",
            sources: "Google 2024 Environmental Report (per-site water data) · Bloomberg 2025",
            image: "assets/img/site-councilbluffs.jpg",
            imageAlt: "A wide river running alongside a city",
            x: 91.7,
            y: 647.7
        },
        {
            ...
            why: "A Great Lakes withdrawal story with the sharpest environmental-justice edge on the map. Microsoft's multi-billion-dollar campus is rising on land seized under eminent domain for the Foxconn deal that never arrived, and the Racine water utility is drawing from Lake Michigan to serve it. Organisers here have been on this ground for years.",
            community: "Mount Pleasant residents displaced by the original Foxconn taking, now living beside the facility that replaced it, and every downstream user of the Lake Michigan withdrawal.",
            sources: "Wisconsin Watch · Milwaukee Journal Sentinel · Belt Magazine",
            image: "assets/img/site-mountpleasant.jpg",
            imageAlt: "Tower cranes over a large construction site",
            x: 540.1,
            y: 515.6
        },
        {
            ...
            why: "The eastern anchor of the map, and a second Meta pin under a far weaker disclosure regime than Illinois. Multi-billion-dollar expansion is underway with active community organising around it — which makes New Albany the clean comparison against Illinois' failed POWER Act attempt.",
            community: "New Albany and the greater Columbus water and energy grid, where residential ratepayers absorb transmission costs driven by industrial load.",
            sources: "Columbus Dispatch · Ohio Environmental Council · local zoning records",
            image: "assets/img/site-newalbany.jpg",
            imageAlt: "Transmission towers silhouetted at sunset",
            x: 854.5,
            y: 686.2
        }
    ];
